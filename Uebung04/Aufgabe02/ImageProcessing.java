    ...
    if(img!=null){
              ...
              // Fouriertransformation------------------------------------------
                       ...
                       Complex[] z=new Complex[img.getWidth()];
                               ...
                               Complex[] z_new=dft.invtrans(c);

                               int[] ruecktrans= new int[img.getWidth()];

                               for(int x=0;x<img.getWidth();x++)
                               {
                                    ruecktrans[x]= -5+(int)z_new[x].getReal();

                               }
                            
          gui.diagramm_01.setParam(werte,ruecktrans);//Werte Bildzeile �bergeben
