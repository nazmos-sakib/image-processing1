              ...
              // Fouriertransformation------------------------------------------
                       ...
                       Complex[] z=new Complex[img.getWidth()];
                               ...
                               int delta=6;
                                ...
                                for(int i=delta; i<img.getWidth()-delta;i++){
                                     c_band1[i]=new Complex(0.0,0.0);
                                }

                                /*
                                for(int x=0;x<img.getWidth()/2; x++)
                                {
                                    c_band1[x]=new Complex(0,0); //putting higher frequency to zero

                                    if(x<=delta)c_band1[x]=c[x];  //lower frequency less than delta
                                    }
                               ...
                               for(int x=0;x<img.getWidth();x++)
                               {
                                    ruecktrans_band1[x]= (int)z_new[x].getReal();
